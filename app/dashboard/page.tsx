    ...
    <AppShell>
      <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 bg-dashboard-mesh min-h-screen">
        ...
        <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4 animate-fade-in-up delay-100">
          {/* Total Estimates */}
          <div className="rounded-xl border border-white/[0.08] border-l-2 border-l-indigo-500 bg-white/[0.04] p-4">
          ...
          {/* Approved */}
          <div className="rounded-xl border border-white/[0.08] border-l-2 border-l-emerald-500 bg-white/[0.04] p-4">
            <div className="flex items-center gap-1.5">
          ...
          {/* Declined */}
          <div className="rounded-xl border border-white/[0.08] border-l-2 border-l-rose-500 bg-white/[0.04] p-4">
            <div className="flex items-center gap-1.5">
            ...
            <p className="mt-2 text-2xl font-bold text-rose-400">{declined}</p>
          </div>
        ...
        <div className="mt-8 grid gap-3 sm:grid-cols-3 animate-fade-in-up delay-200">
          ...
          <Link
            href="/estimate"
            className="card-hover group rounded-xl bg-white/[0.04] border border-white/[0.08] p-4 hover:border-indigo-500/25 hover:shadow-lg hover:shadow-indigo-500/5"
          >
          ...
          {/* Use Template */}
          <div
            className="card-hover group rounded-xl bg-white/[0.04] border border-white/[0.08] p-4 hover:border-violet-500/25 hover:shadow-lg hover:shadow-violet-500/5 cursor-pointer"
          ...
          <a
            href="#invoices"
            className="card-hover group rounded-xl bg-white/[0.04] border border-white/[0.08] p-4 hover:border-emerald-500/25 hover:shadow-lg hover:shadow-emerald-500/5"
          >
        ...
        <div id="estimates" className="scroll-mt-6 mt-10 animate-fade-in-up delay-400">
          ...
          {estimates.length === 0 ? (
            <div className="mt-3 rounded-xl bg-white/[0.04] border border-white/[0.08] px-4 py-6 text-center">
              ...
              <div className="mt-3">
                <Link href="/estimate" className="inline-flex items-center gap-1.5 rounded-lg bg-indigo-600 px-3.5 py-1.5 text-xs font-semibold text-white transition-all hover:bg-indigo-500">
                  Create Estimate
                </Link>
              </div>
            </div>
